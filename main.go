...
func messageCreate(s *discordgo.Session, m *discordgo.MessageCreate) {
	...
	if strings.EqualFold(m.Content, "???") {
		s.ChannelMessageSend(m.ChannelID, "https://cdn.vox-cdn.com/thumbor/TTfy8-LQoSYXhtmEaEx7-p4daT8=/0x0:300x169/1600x900/cdn.vox-cdn.com/uploads/chorus_image/image/52758323/nick_young_confused_face_300x256_nqlyaa.0.png")
	}
